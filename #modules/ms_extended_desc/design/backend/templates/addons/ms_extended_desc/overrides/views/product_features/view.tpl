...
<!-- Вывод расширенного описания Бренда (module: ms_extended_desc) -->
<div class="ms_extended_desc">
    {$variant_data.extended_description_brend nofilter}
</div>
<!-- Конец вывода расширенного описания Бренда (module: ms_extended_desc) -->
